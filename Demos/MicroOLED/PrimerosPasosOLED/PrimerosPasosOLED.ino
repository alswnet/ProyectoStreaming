...
void loop() {
  ...
  oled.setFontType(1);      //tipo de fuente (0) significa el tamaño mas pequeño 5x7 pixel por caracter maximo 10 por columna 6 por fila
  oled.setCursor(10,10);      //ubicamos el cursor donde incia el texto
  oled.print("ALSW");       //escribimos texto
  oled.display();           //Mostrar lo que hay en el buffer
  delay(3000);  

  oled.setCursor(10,8);      //ubicamos el cursor donde incia el texto
  oled.print("Feliz");       //escribimos texto
  oled.display();           //Mostrar lo que hay en el buffer
  delay(3000);

  oled.setCursor(10,16);      //ubicamos el cursor donde incia el texto
  oled.print("Cumple");       //escribimos texto
  oled.display();           //Mostrar lo que hay en el buffer
  delay(3000);

  oled.setCursor(10,24);      //ubicamos el cursor donde incia el texto
  oled.print("ALSW");       //escribimos texto
  oled.display();           //Mostrar lo que hay en el buffer
  delay(3000);
  oled.clear(PAGE); // Borra lo que hay en el buffer
